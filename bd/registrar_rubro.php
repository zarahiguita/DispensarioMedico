...
$insertar = "INSERT INTO rubro(rubro_presupuestal, descripcion_rubro, fecha_creacion, fecha_actualizacion) 
VALUES ('$rubro_presupuestal', '$descripcion_rubro', '$fecha_creacion', '$fecha_actualizacion')";
...
<?php else: ?>
    Swal.fire({
        ...
        html: '<b>El rubro fue creado correctamente.</b>',
        ...
        window.location.href = '../vista/form_rubro.php';
    });
<?php endif; ?>
</script>
</body>
