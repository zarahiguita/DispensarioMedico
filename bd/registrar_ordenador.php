...
$insertar = "INSERT INTO ordenador_gasto(grado, nombre, cedula, lugar_expedicion_cedula) 
VALUES ('$grado', '$nombre', '$cedula', '$lugar')";
...
<?php else: ?>
    Swal.fire({
        ...
        html: '<b>El ordenador del gasto fue creado correctamente.</b>',
