...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $insertar = "INSERT INTO aseguradora(nombre, nit) VALUES ('$nombre', '$nit')";
    ...
    <?php if (!$resultado): ?>
        Swal.fire({
            icon: 'error',
            title: '¡Error!',
            text: 'No se pudo guardar la aseguradora.',
    ...
    <?php else: ?>
        Swal.fire({
            ...
            window.location.href = 'form_aseguradora.php';
        });
    <?php endif; ?>
    </script>
    </body>
...
<body>
<h2 class="form__titulo">Registro de Aseguradora</h2>
