...
<head>
    ...
    <meta charset="UTF-8">
    <title>Carga de la poliza firmada</title>
    <style>
        * {
...
<div class="contenido">
    <div class="titulo">SUBIR POLIZA FIRMADA</div>

    <div class="container">
        <p class="nota"> Aqui vas a poder subir y guardar el contrato de la poliza ya firmado. Solo se permiten archivos WORD y PDF</p>
        <form method="POST" action="procesar_contrato_poliza.php" enctype="multipart/form-data" onsubmit="mostrarSpinner()">
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<form id="formactaRedirect" method="GET" action="../vista/formulario_acta.php" style="display: none;">
    <input type="hidden" name="cedula" value="<?= htmlspecialchars($cedula) ?>">
</form>
<script>
   ...
   const cedula = '<?= $cedula ?>';
    ...
    if (getParam('exito') === '1') {
        ...
        Swal.fire({
            ...
            html: `<b>El archivo <u>${archivo}</u> fue cargado correctamente.</b><br><br>¿Desea continuar con el ingreso del acta de inicio?`,
            ...
            if (result.isConfirmed) {
              ...
              document.getElementById('formactaRedirect').submit();
            } else {
                window.location.href = 'subir_poliza.php';
            }
        });
    }
</script>
