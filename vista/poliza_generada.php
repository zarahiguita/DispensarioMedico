...
$ruta_archivo = 'contratos_poliza/' . $archivo;
 ...
 <div class="main-wrapper">
    <div class="container">
        <?php if ($archivo && $existeArchivo): ?>
            <h1>✅ Poliza generada correctamente a nombre de <?= htmlspecialchars($nombre_usuario) ?></h1>
            <p>Haz clic en el siguiente botón para descargar el archivo:</p>
            <a href="<?= $ruta_archivo ?>" download class="btn">📄 Descargar Poliza</a>
        <?php else: ?>
