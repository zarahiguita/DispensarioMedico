...
<head>
    ...
    <meta charset="UTF-8">
    <title>Carga del acta firmado</title>
    <style>
        * {
...
<div class="contenido">
    <div class="titulo">SUBIR ACTA DE INICIO FIRMADA</div>

    <div class="container">
        <p class="nota"> Aqui vas a poder subir y guardar el acta de inicio  ya firmado. Solo se permiten archivos WORD y PDF</p>
        <form method="POST" action="procesar_contrato_acta.php" enctype="multipart/form-data" onsubmit="mostrarSpinner()">
    ...
    <label for="tipo_acta" style="display:block;margin:8px 0 4px;">¿Dónde desea guardar el acta firmada?</label>
<select name="tipo_acta" id="tipo_acta" required style="width:100%;padding:8px;border-radius:6px;margin-bottom:12px;">
  <option value="" selected disabled>Seleccione una opción…</option>
  <option value="prestacion">Prestación de servicios (firmada)</option>
  <option value="contrato">Contrato (firmada)</option>
</select>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<form id="formPolizaRedirect" method="GET" action="../vista/formulario_busqueda.php" style="display: none;">
    <input type="hidden" name="cedula" value="<?= htmlspecialchars($cedula) ?>">
</form>
<script>
